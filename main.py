...
print('Splitting ...', end="")
X_train, X_test, y_train, y_test = train_test_split(features_encoded, criteria, test_size=0.2, random_state=42)
print("Done")
...
# - true positive (clean data predicted to be clean data) and false negative (clean data predicted to be fraud data),
# - true negative (fraud data predicted to be fraud data) and false positive (fraud data predicted to be clean data)
